            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200">
                    <div class="px-6 py-5 border-b border-slate-200">
                        <h4 class="font-bold text-xl text-slate-800 mb-1">Welcome back</h4>
                    ...
                    <div class="p-6">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="{{ route('password.request') }}" class="text-sm text-indigo-600 hover:text-indigo-800 underline">Forgot?</a>
                                </div>
                            ...
                            <div class="mb-4 flex items-center">
                                <input type="checkbox" class="h-4 w-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500" id="remember" name="remember">
                        ...
                        <div class="relative my-5">
                            ...
                            <span class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-3 text-slate-500 text-xs">or continue with</span>
                        </div>

                        <div class="flex flex-col gap-2">
                            <a href="{{ route('social.redirect', 'google') }}" class="border border-slate-300 text-slate-600 px-4 py-3 rounded-lg hover:bg-slate-50 transition-colors font-medium flex items-center justify-center gap-2">
                            ...
                            <a href="{{ route('social.redirect', 'github') }}" class="border border-slate-300 text-slate-600 px-4 py-3 rounded-lg hover:bg-slate-50 transition-colors font-medium flex items-center justify-center gap-2">
                            ...
                            <a href="{{ route('social.redirect', 'facebook') }}" class="border border-slate-300 text-slate-600 px-4 py-3 rounded-lg hover:bg-slate-50 transition-colors font-medium flex items-center justify-center gap-2">
                        ...
                        <div class="text-center mt-5">
                            <p class="text-slate-500 text-sm">Don't have an account? <a href="{{ route('register') }}" class="font-semibold text-indigo-600 hover:text-indigo-800">Create one</a></p>
                        </div>
                    </div>
                </div>
