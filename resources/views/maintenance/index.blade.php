...
<x-table title="Maintenance Requests" :headers="['title' => 'Title', 'unit' => 'Unit', 'priority' => 'Priority', 'status' => 'Status', 'date' => 'Date', 'actions' => 'Actions']">
    <x-slot name="actions">
    ...
    <tr>
        <td colspan="6" class="px-4 py-12 text-center">
            <x-empty-state message="No maintenance requests found." />
        </td>
    </tr>
    @endforelse
    <x-slot name="footer">
