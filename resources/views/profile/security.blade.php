...
<div class="mb-6">
    ...
    <p class="text-slate-500 mt-1">Manage your account security and connected accounts</p>
</div>
    ...
    <div>
        <div class="bg-white rounded-xl shadow-sm border border-slate-200">
            <div class="p-6">
                ...
                <p class="text-slate-500 text-sm mb-4">Add an extra layer of security by requiring a verification code in addition to your password.</p>
                ...
                @if($user->hasTwoFactorEnabled())
                    ...
                    <form method="POST" action="{{ route('two-factor.disable') }}" class="mt-4" onsubmit="return confirm('Are you sure you want to disable two-factor authentication?');">
                        @csrf
                        <div class="mb-3">
                            <label for="password" class="block text-sm font-medium text-slate-700 mb-1.5">Enter your password to disable</label>
                            <input type="password" class="w-full px-3 py-2.5 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" id="password" name="password" placeholder="Your current password" required>
                        </div>
                ...
                @else
                    ...
                    <p class="text-sm text-slate-500 mt-3 mb-4">To enable 2FA, we'll send a verification code to your email. Enter it below to confirm.</p>

                    <form method="POST" action="{{ route('two-factor.enable') }}" class="grid grid-cols-1 sm:grid-cols-4 gap-2">
                        @csrf
                        <div class="sm:col-span-3">
                            <input type="text" class="w-full px-3 py-2.5 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" id="code" name="code" placeholder="Enter 6-digit code" maxlength="6" inputmode="numeric" pattern="[0-9]*">
                        </div>
                        <div>
                    ...
                    <div class="mt-4 p-4 bg-slate-800 text-white rounded-xl">
                        ...
                        <p class="text-sm text-white/70 mb-3">Save these codes in a secure place. Each code can be used once to access your account if you lose your 2FA device.</p>
    ...
    <div class="space-y-6">
        <div class="bg-white rounded-xl shadow-sm border border-slate-200">
            <div class="p-6">
                ...
                <p class="text-slate-500 text-sm mb-4">Link your social accounts for one-click login.</p>
                ...
                <div class="flex items-center justify-between py-3 border-b border-slate-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-medium text-slate-800">Google</div>
                ...
                <div class="flex items-center justify-between py-3 border-b border-slate-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-medium text-slate-800">GitHub</div>
                            <small class="text-slate-500">
                ...
                <div class="flex items-center justify-between py-3 border-b border-slate-200">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-medium text-slate-800">Facebook</div>
                            <small class="text-slate-500">
