    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-8">
        <aside class="lg:col-span-3 mb-6 lg:mb-0">
            <form method="GET" class="bg-white rounded-xl shadow-sm border border-slate-200 p-5 space-y-5 sticky top-24">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Features</label>
                    <div class="space-y-2">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Amenities</label>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('listings.index') }}" class="px-4 py-2 text-sm text-slate-600 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors">Reset</a>
                </div>
            </form>
        </aside>
        ...
        <div class="lg:col-span-9">
            <div class="flex items-center justify-between mb-4">
                <p class="text-sm text-slate-500">Showing {{ $properties->firstItem() }}-{{ $properties->lastItem() }} of {{ $properties->total() }}</p>
                ...
                <a href="{{ route('listings.show', $property) }}" class="group bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between mt-3 pt-3 border-t border-slate-100">
                            ...
                            <span class="text-xs font-semibold text-indigo-600">From {{ number_format($property->units->min('rent_amount') ?? 0, 0, ',', ' ') }} FCFA</span>
                        </div>
                    </div>
                </a>
                @endforeach
